...
#SBATCH --job-name=train_test_time_time_category
...
matlab -nosplash -noFigureWindows -r "time_time_category_decoding_between_methods(${sub}, ${methods}, ${cond})" > serial.out #this worked
echo set to run
